...
});define("appmsg/comment.js",["biz_common/dom/class.js","appmsg/cmt_tpl.html.js","biz_common/utils/wxgspeedsdk.js","appmsg/comment_report.js","biz_wap/utils/device.js","appmsg/retry_ajax.js","biz_common/dom/offset.js","biz_common/utils/url/parse.js","biz_wap/jsapi/core.js","common/utils.js","appmsg/emotion/selection.js","appmsg/i18n.js","biz_common/dom/event.js","biz_wap/utils/ajax.js","biz_common/utils/string/html.js","biz_common/tmpl.js","biz_wap/utils/fakehash.js","appmsg/log.js","appmsg/comment_tpl.html.js","appmsg/comment_pc_tpl.html.js","appmsg/friend_comment_tpl.html.js","appmsg/my_comment_tpl.html.js","appmsg/emotion/emotion_pc.js","appmsg/emotion/emotion.js","appmsg/emotion/dom.js"],function(e,t,n,o){
"use strict";
function i(e,t){
...
function c(){
bt.mylist.children.length?(i(bt.mylist.parentNode),device_is_pc||S.removeClass(document.body,st)):(m(bt.mylist.parentNode),
device_is_pc||S.addClass(document.body,st));
}
function d(e){
...
try{
kt++,e&&(Et=[]),kt>1&&!e&&r(dt.moreList,encodeURIComponent(c)),Et.indexOf(c)>-1&&r(dt.repeatList,encodeURIComponent(c)),
Et.push(c);
}catch(d){}
...
_t.log("tag1");
var e;
if(e=window.device_is_pc?a(Dt).replace(/<br\/>/g,"").replace(/\n/g,"")||"":a(bt.input.value),
...
window.device_is_pc&&(e=Dt),_t.log("tag5"),device_is_pc?bt.submit.disabled=!0:S.addClass(bt.submit,"btn_disabled"),
_t.log("tag6");
var t=document.getElementById("activity-name");
_t.log("tag7"),Bt!=e&&(Tt=+new Date);
var n=function(t){
{
...
"en"==LANG&&(l.like_num_format=V.dealLikeReadShow_en(l.like_num)),l.is_from_friend="friend"==n?0:l.is_from_friend||0,
l.is_from_me="mine"==n?1:l.is_from_me||0,l.reply=l.reply||{
reply_list:[]
...
"en"==LANG&&(l.reply.reply_list[0].reply_like_num_format=V.dealLikeReadShow_en(l.reply.reply_list[0].reply_like_num))),
l.new_appmsg=window.new_appmsg,i+=it.tmpl(A,l);
try{
var s=l.nick_name+l.content,_=!1,p=dt.repeatContentID;
Ct[s]&&(_=!0,p=dt.repeatContent),It.indexOf(l.content_id)>-1&&(_=!0,p=dt.repeatContentID),
It.push(l.content_id),Ct[s]=!0,_&&r(p,encodeURIComponent(JSON.stringify({
comment_id:tt,
...
console.log(lt),window.scrollTo(0,lt),bt.input.blur(),S.removeClass(document.body,at),
S.removeClass(document.body,st),$.isNativePage()||"5"!==window.item_show_type||(Z.invoke("setNavigationBarColor",{
color:"#1f1f1f"
...
function z(e,t){
if(!I()){
if($.isNativePage()||"5"!==window.item_show_type||(S.addClass(document.body,at),
...
repeatContent:24,
repeatContentID:23
},lt=null,at="comment_editing",st="my_comment_empty_data";
...
window.device_is_pc?(H("js_cmt_mine"),document.getElementById("js_avatar_pc").src=window._logo_url,
S.addClass(document.body,"pages_skin_pc")):H("js_cmt_addbtn_pc");
var ht=!1,jt=["“”","‘’","（）","《》","〈〉","「」","『』","〔〕","【】","［］","[]","｛｝","{}","()","<>"],bt={
...
var vt,It=[],Ct={},Et=(new Image,[]),kt=0,Bt=null,Tt=+new Date;
...
var n=a(bt.input.value||bt.input.innerHTML);
...
}),nt.on(bt.list,"click",".js_comment_praise",k),nt.on(bt.mylist,"click",".js_comment_praise",k),
nt.on(bt.fdlist,"click",".js_comment_praise",k),nt.on(bt.list,"click",".js_reply_praise",B),
nt.on(bt.fdlist,"click",".js_reply_praise",B),nt.on(bt.list,"click",".js_del",D),
nt.on(bt.mylist,"click",".js_del",D),nt.on(bt.fdlist,"click",".js_del",D),$.listenMpPageAction(function(e){
...
e.preventDefault();
}),bt.goback&&(nt.on(bt.goback,"click",L),nt.on(bt.goback,"click",L)),window.__second_open__&&J.os.ios){
nt.on(bt.input,"click",function(){
m(bt.fakebar);
...
var t=e();
t=s(t),Dt=rt.textFilter(t),_();
},_=function(){
var e=a(Dt).replace(/<br\/>/g,"").replace(/\n/g,"").length;
Nt.innerText=e,e>600?(Ht.style.display="",S.addClass(Ht,"comment_primary_counter_warn"),
bt.submit.disabled=!0):1>e?(Ht.style.display="none",S.removeClass(Ht,"comment_primary_counter_warn"),
bt.submit.disabled=!0):(Ht.style.display="none",S.removeClass(Ht,"comment_primary_counter_warn"),
...
Dt="",Lt=K.getRange(),Mt=rt.edata,Ht=document.getElementById("js_length_notice_pc"),
...
zt&&clearTimeout(zt),zt=setTimeout(function(){
return l(),c(),r(),!1;
},10);
...
""===a(o)&&(m(bt.containerPC),i(bt.inputPC),m(n));
}
